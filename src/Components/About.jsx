...
const About = () => {
    return (
      <div>
        ...
        <p>I was a Software Engineer @ <a target="_blank" rel="noopener noreferrer" href="https://www.microsoft.com/en-us/">Microsoft</a> from Jan 25, 2019 - Dec 11, 2023.</p>  
        ...
        <section>
          <h3>Education</h3>
          <p>
            <strong>University of the Pacific, </strong>  B.A. in Music Violin & Asian Languages and Studies: Chinese, Minor in Pre-Law 
            <br />
            <em>Relevant Courses: Intro to Computer Science (C++), Data Structures</em>
          </p>
